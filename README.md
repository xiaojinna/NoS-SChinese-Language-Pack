...
## 关于成就翻译（About Achievements Translation）

成就文本中包含大量梗、双关与文化指代内容，受语言差异与个人理解所限，部分翻译可能无法完全还原原意或不够“接地气”，敬请谅解。  
如有更合适的翻译方案，欢迎提出建议。

Achievement texts contain a large number of jokes, wordplays, and cultural references.  
Due to language differences and personal interpretation, some translations may not fully convey the original intent.  
Suggestions for improvement are welcome.

---

## 使用与分发限制（Usage & Redistribution）

本翻译扩展包为非官方衍生作品，其**翻译文本版权归作者本人所有**。

This translation add-on is an unofficial derivative work, and **the copyright of the translation text belongs to the author**.

### 允许（Permitted）

- 个人下载、安装及使用本插件；  
- 为个人游玩或测试目的进行私下修改（不公开发布）。

- Personal download, installation, and use of this add-on;  
- Private modifications for personal gameplay or testing purposes only.

### 禁止（Prohibited）

- **未经作者明确许可，将本翻译内容（包括修改后的版本）整合、合并、包含或引用于其他插件包、整合包或扩展中并进行发布；**  
- **以任何形式重新发布、二次发布、镜像发布或转发本翻译内容；**  
- 未署名使用或声明为“官方翻译”；  
- 将本翻译内容用于任何商业用途。

- **Redistribution, re-uploading, mirroring, or inclusion of this translation (including modified versions) in other add-ons, mod packs, or bundles without explicit permission from the author;**  
- Claiming this translation as an official release;  
...
Bilibili：https://space.bilibili.com/439485056
